...
const testimonials = [
  {
    name: "Katie R.",
    image: "/images/avatars/avatar-katie.png",
    text: "Trimora changed my life. I lost 38 lbs in 6 months and the care coaching kept me motivated the whole way through.",
    rating: 5,
    program: "Weight Loss",
  },
  {
    name: "Mike D.",
    image: "/images/avatars/avatar-mike.png",
    text: "The men's health program gave me my energy back. The process was seamless and the doctors really listened.",
    rating: 5,
    program: "Men's Health",
  },
  {
    name: "Jennifer L.",
    image: "/images/avatars/avatar-jennifer.png",
    text: "Finally, a telehealth service that actually delivers. Having everything shipped to my door is a game changer.",
    rating: 5,
    program: "Weight Loss",
  },
  {
    ...
    text: "I was skeptical at first, but the results speak for themselves. Down 31 lbs and feeling better than I have in years.",
    rating: 5,
    program: "Weight Loss",
  },
  {
    name: "Patricia M.",
    image: "/images/avatars/avatar-patricia.png",
    text: "The meal plans made healthy eating so much easier. Combined with the GLP-1 treatment, it's been life-changing.",
    rating: 5,
    program: "Nutrition",
  },
  {
    name: "Thomas W.",
    image: "/images/avatars/avatar-thomas.png",
    text: "Professional, discreet, and effective. The monthly check-ins with my provider make me feel truly cared for.",
    rating: 5,
    program: "Men's Health",
  },
  {
    name: "Rachel G.",
    image: "/images/avatars/avatar-rachel.png",
    text: "I appreciate the transparent pricing — no hidden fees, no surprises. The quality of care exceeded my expectations.",
    rating: 5,
    program: "Weight Loss",
  },
  {
    name: "David W.",
    image: "/images/avatars/avatar-david.png",
  ...
  {
    name: "Emily J.",
    image: "/images/avatars/avatar-emily.png",
    text: "From consultation to medication delivery, everything was fast and easy. Lost 25 lbs and still going!",
    rating: 5,
    program: "Weight Loss",
  },
  {
    name: "Andrew B.",
    image: "/images/avatars/avatar-andrew.png",
  ...
  {
    name: "Sarah K.",
    image: "/images/avatars/avatar-sarah.png",
  ...
  {
    name: "Shannon B.",
    image: "/images/avatars/avatar-shannon.png",
